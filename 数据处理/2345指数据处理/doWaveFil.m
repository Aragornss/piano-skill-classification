%% doWaveFil函数，数据滤波
function doWaveFil(angle1,angle2)
%% 数据滤波
%平滑均值滤波-Lab10         https://blog.csdn.net/guomutian911/article/details/41576689
figure('NumberTitle', 'off', 'Name', '弱指协同触键滤波曲线观察');%更好更有用
DL1=length(angle1);
...
set(gcf,'color','w');
h1=legend([p01, p02],'4\fontname{宋体}指\fontname{Times New Roman}MCP','3\fontname{宋体}指\fontname{Times New Roman}MCP');
